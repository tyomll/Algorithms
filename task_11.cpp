...
std::vector<range> merge_ranges(std::vector<range>& input_ranges) {
...
int main() {
    std::vector<range> input_ranges = {{1, 3}, {2, 6}, {8, 13}, {15, 18}};
    std::vector<range> result = merge_ranges(input_ranges);
