...
void input_matrix(int &row1, int &row2, int &column1, int &column2, std::vector<std::vector<int>> &matrix1, std::vector<std::vector<int>> &matrix2) {
...
void print_matrix(int row1, int column2, const std::vector<std::vector<int>> &matrix3) {
    for (int i = 0; i < row1; ++i) {
        for (int j = 0; j < column2; ++j) {
